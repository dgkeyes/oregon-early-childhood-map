...
#   "Frontier Early Learning Hub", "25 Fairview Hts, Burns OR 97720", "Harney, Grant", "https://harneyesd.sharpschool.com/e_c_c/harney_grant_frontier_hub",
...
early_learning_hubs <- read_csv("data-clean/early-learning-hubs-locations.csv")
...
st_write(early_learning_hubs_regions, "data-clean/early-learning-hubs-regions.shp")
